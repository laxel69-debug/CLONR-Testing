      ...
      <header>
        ...
        <section class="products-section">
            <div class="section-header">
                <h2>JACKETS</h2> <select id="price-sort" class="price-sort">
            ...
            <div class="products-grid" id="products-grid">
                ...
                if ($products) { 
                    foreach ($products as $row) {
                        ...
                        echo '<a href="jackets/JacketsProductsDisplay.php?id=' . $productId . '">';
                    ...
                    echo "<p>No jacket products found.</p>";
                }
                ?>
            </div>
