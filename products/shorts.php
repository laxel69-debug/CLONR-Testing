...
<html lang="en">
    <head>
        ...
        <title>Jackets - CLONR</title> <link rel="stylesheet" href="../global.css"/>
      ...
      <header>
        ...
        <section class="products-section">
            <div class="section-header">
                <h2>SHORTS</h2> <select id="price-sort" class="price-sort">
            ...
            <div class="products-grid" id="products-grid">
                ...
                try {
                    ...
                    $stmt->execute([':category' => 'Shorts']);
                    $products = $stmt->fetchAll(PDO::FETCH_ASSOC); 
                } catch (\PDOException $e) {
                    error_log("Database Query Error in Shorts.php: " . $e->getMessage());
                    $products = []; 
                ...
                if ($products) { 
                    foreach ($products as $row) {
                        ...
                        echo '<a href="shorts/ShortsProductsDisplay.php?id=' . $productId . '">';
                    ...
                    echo "<p>No Shorts products found.</p>";
                }
                ?>
            </div>
