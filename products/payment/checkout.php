...
if(isset($_POST['order'])){
   ...
   $address = $_POST['street'] .' '. $_POST['brgy'] .' '. $_POST['city'] .' '. $_POST['region'] .' '. $_POST['country'];
...
<html lang="en">
    ...
    <body>
        ...
        <?php
            ...
            // Retrieve cart items
            $select_cart_items = $conn->prepare("SELECT name, price, quantity FROM `cart` WHERE user_id = ?");
        ...
        ?>
                    ...
                    <p><?= htmlspecialchars($fetch_cart_items['name']); ?> 
        ...
        <form action="" method="POST">
            ...
            <div class="flex">
              ...
              <div class="inputBox">
                  <span>Street No. and Street Name :</span>
                  <input type="text" name="street" placeholder="e.g. #1 Paz" class="box" required>
              </div>
              <div class="inputBox">
                  <span>Barangay :</span>
                  <input type="text" name="brgy" placeholder="e.g. Tugatog" class="box" required>
              </div>
              <div class="inputBox">
                  <span>City :</span>
                  <input type="text" name="city" placeholder="e.g. Malabon" class="box" required>
              </div>
              <div class="inputBox">
                  <span>Region :</span>
                  <input type="text" name="region" placeholder="e.g. Metro Manila" class="box" required>
              </div>
              <div class="inputBox">
                  <span>Country :</span>
