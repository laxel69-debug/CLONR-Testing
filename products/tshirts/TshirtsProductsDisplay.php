...
if (!isset($conn) || !$conn) {
     error_log("Database connection is not established in ShortsProductsDisplay.php");
...
if ($productId) {
    try {
        ...
        error_log("Database Query Error in ShortsProductsDisplay.php: " . $e->getMessage());
...
if (!$product) {
    ...
    echo '<p><a href="../shorts.php">Back to Shorts</a></p>'; 
    exit;
}
...
<html lang="en">
    <head>
        ...
        <title>
            <?php echo $productName; ?> - CLONR</title> <link rel="stylesheet" href="../../global.css"/> <link rel="stylesheet" href="../addtocart.css">
