...
if (!isset($conn) || !$conn) {
     error_log("Database connection is not established in Pants.php");
...
<html lang="en">
    <head>
        ...
        <title>Pants - CLONR</title> <link rel="stylesheet" href="../global.css"/>
      ...
      <header>
        ...
        <section class="products-section">
            <div class="section-header">
                <h2>PANTS</h2> <select id="price-sort" class="price-sort">
            ...
            <div class="products-grid" id="products-grid">
                ...
                try {
                    ...
                    $stmt->execute([':category' => 'Pants']);
                    $products = $stmt->fetchAll(PDO::FETCH_ASSOC); 
                } catch (\PDOException $e) {
                    error_log("Database Query Error in Pants.php: " . $e->getMessage());
                    $products = []; 
                    echo "<p>Error loading pants. Please try again later.</p>";
                }
                ...
                if ($products) { 
                    ...
                    foreach ($products as $row) {
                        ...
                        echo '<a href="pants/PantsProductsDisplay.php?id=' . $productId . '">';
                    ...
                    echo "<p>No pants products found.</p>";
                }
                ?>
            </div>
