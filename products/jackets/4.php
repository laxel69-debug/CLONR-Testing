    ...
    <header>
      ...
      <section class="product-section">
        <div class="product-details">
          <h2>JACKETS</h2>
          <h1>OAKSHADE WORKWEAR JACKET</h1>
          <p>₱2,800.00</p>
        ...
        <div class="product-slider">
          ...
          <img id="slider-image" src="https://dbtkco.com/cdn/shop/files/OAKSHADEWORKWEARJACKET1.jpg?v=1737095917" alt="Cipher Tee">
      ...
      <script>
        ...
        "https://dbtkco.com/cdn/shop/files/OAKSHADEWORKWEARJACKET2.jpg?v=1737095917",
        "https://dbtkco.com/cdn/shop/files/OAKSHADEPOLO.webp?v=1737095917"
        ];
