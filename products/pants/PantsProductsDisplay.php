...
<html lang="en">
    ...
    <header>
      ...
      <section class="product-section">
        <div>
          <a href="../pants.php" class="back-button" style="display: inline-flex; align-items: center; padding: 10px 15px; text-decoration: none; color:rgb(0, 0, 0); font-weight: 500; font-size: 14px; border-radius: 6px; transition: all 0.2s ease;">
